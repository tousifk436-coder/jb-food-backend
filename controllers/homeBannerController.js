...
//           400,
//           null,
//           "Desktop banner image is required. Use the field name 'desktopImage'."
//         )
//       );
//     }
...
// /* =====================================================
//    GET ACTIVE BANNERS — PUBLIC WEBSITE
// ===================================================== */

// const getActiveHomeBanners = asyncHandler(
//   async (req, res) => {
...
//     let query = HomeBanner.find(filter).sort(
//       selectedSort
//     );
...
// const getHomeBannerById = asyncHandler(
//   async (req, res) => {
//     const { id } = req.params;
...
//         banner.desktopImage?.publicId;

//       const oldMobilePublicId =
//         banner.mobileImage?.publicId;

//       if (
//         req.body.eyebrow !== undefined
//       ) {
//         banner.eyebrow =
//           req.body.eyebrow.trim();
//       }
...
//       if (
//         req.body.highlightedText !==
//         undefined
//       ) {
//         banner.highlightedText =
//           req.body.highlightedText.trim();
//       }
...
//       if (
//         req.body.primaryButtonLabel !==
//         undefined
//       ) {
//         banner.primaryButton.label =
//           req.body.primaryButtonLabel.trim();
//       }
...
//           req.body.primaryButtonUrl.trim();
//       }

//       if (
//         req.body.secondaryButtonLabel !==
//         undefined
//       ) {
//         banner.secondaryButton.label =
//           req.body.secondaryButtonLabel.trim();
//       }

//       if (
//         req.body.secondaryButtonUrl !==
//         undefined
//       ) {
//         banner.secondaryButton.url =
//           req.body.secondaryButtonUrl.trim();
//       }
...
//         undefined
//       ) {
//         banner.overlayOpacity = Math.min(
//           1,
//           Math.max(
//             0,
//             parseNumber(
